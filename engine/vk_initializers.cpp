...
VkCommandPoolCreateInfo vkinit::command_pool_create_finfo(uint32_t queueFamilyIndex,VkCommandPoolCreateFlags flags /*= 0*/)
{
...
VkPipelineInputAssemblyStateCreateInfo vkinit::input_assembly_create_info(VkPrimitiveTopology topology)
{
    ...
    //primitive restart is not used in this tutorial
...
VkPipelineMultisampleStateCreateInfo vkinit::multisampling_state_create_info()
{
    ...
    //multisampling defaulted to no multisampling (only 1 sample per pixel)
